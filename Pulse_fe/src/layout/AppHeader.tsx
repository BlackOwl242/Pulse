      ...
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
          ...
          <div className="hidden xl:block">
            <button onClick={() => setIsSearchOpen(true)} className="flex items-center w-full">
              <div className="relative w-full">
                ...
                <div className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/30 xl:w-[430px] flex items-center cursor-pointer hover:border-gray-300 dark:hover:border-gray-700 transition-colors">

...
export const meetingService = {
    ...
    update: (slug: string, id: string, data: { title: string; description?: string; agenda?: string; startTime: string; endTime: string; participantIds?: string[] }) =>
        api.put(`/workspaces/${slug}/meetings/${id}`, data).then(r => r.data),

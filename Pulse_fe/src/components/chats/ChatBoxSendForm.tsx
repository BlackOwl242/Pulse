...
export default function ChatBoxSendForm({ msgInput, setMsgInput, sendMessage, sending }: ChatBoxSendFormProps) {
  return (
    <div className="sticky bottom-0 p-3 border-t border-gray-200 dark:border-gray-800 shrink-0">
      <form className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <button onClick={(e) => { e.preventDefault(); sendMessage(); }} disabled={sending || !msgInput.trim()} className="flex items-center justify-center ml-3 text-white rounded-lg h-9 w-9 bg-brand-500 hover:bg-brand-600 xl:ml-5 disabled:opacity-50">
